...
- [x] The generator requires an existing profile and at least one measurement with neck and abdomen values.
- [x] It creates 30 daily measurements, alternating weight-and-sizes and weight-only records.
...
- [x] Application tests cover generation, variation ranges, calculation-result persistence, idempotence, and the missing-size guard.
