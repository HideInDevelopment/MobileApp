...
public sealed class MifflinStJeorMaleBmrFormula : ICalculationFormula<BmrInput, CalculationResultValue>
{
    public CalculationType Type => CalculationType.BasalMetabolicRate;

    public string FormulaId => "mifflin-st-jeor-male-bmr";
    ...
    public Result<CalculationResultValue> Calculate(BmrInput input)
    {
        ...
        var bmr = 10m * input.WeightKg + 6.25m * input.HeightCm - 5m * input.AgeYears + 5m;
